...
async def require_operator_token(x_operator_token: str | None = Header(None, alias="X-Operator-Token")) -> str:
    settings = get_settings_instance()
    if not x_operator_token or x_operator_token != settings.operator_token:
